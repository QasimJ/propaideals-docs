...
Sign up at [propaideals.co.uk/sign-up](https://propaideals.co.uk/sign-up) — every account includes the **Free API plan**: 200 credits a month at 2 req/s, no card required. You can create a key and make your first call without subscribing to anything.

When you need more, paid plans start **from £29/mo** (Starter, 2,500 credits) through Growth (from £59/mo, 7,500 credits), Advanced (£99/mo, 20,000 credits), Professional (£299/mo, 100,000), and Business (£999/mo, 400,000) at [propaideals.co.uk/dashboard/api](https://propaideals.co.uk/dashboard/api). See [Rate limits](./rate-limits#plan-comparison) for the full comparison.
...
(Values shown for the Free plan — a paid plan reports its own limits here.)
