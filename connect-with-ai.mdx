...
> **Looking for the property data itself in Claude?** This page covers the **docs** MCP server (public, read-only, for coding agents). To give Claude direct access to the **data** — valuations, comparables, deal scores — connect `https://api.propaideals.co.uk/mcp` instead: see [Connect to Claude (MCP)](./connect-to-claude).
...
If you have an issue connecting an AI agent or want a feature, email `info@propaideals.co.uk`.
