...
description: Search, list, and retrieve UK property listings from Rightmove, Zoopla, and OnTheMarket. 140+ filter parameters, BMV scoring, rental yields, agent details. Required scope properties:read.
---

# Properties

The `/api/v1/properties` endpoint is the workhorse of the Prop AI Deals API. It serves 2.1M+ live UK property listings with deep filtering, BMV scoring, rental yield estimates, and agent details.
