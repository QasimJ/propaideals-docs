...
**Available on:** every plan carries the `areas:read` scope, including Free. The postcode analytics endpoints additionally require a Pro or Founder **platform** subscription and return `402` otherwise.
