...
| `avg_days_listed` | number | Mean age in days of listings that are **still active** — how long unsold stock has been sitting. Not time-to-sell: sold listings are excluded from the average entirely. Replaces `avg_days_on_market`, removed 2026-08-13 — see the [changelog](../changelog). |
