...
You've used 2× your monthly request allowance (a hard cap above the soft limit).
...
**Fix:** Wait until the next billing period or upgrade your plan.

### `ai_chat_quota_exceeded` — 429

AI chat endpoints have a separate monthly quota that's been used up.

```json
{
  "error": {
    "code": "ai_chat_quota_exceeded",
    "message": "AI chat quota exceeded for this billing period"
  }
}
```

**Fix:** Wait until the next billing period or upgrade. AI requests cost 5× a normal request.
